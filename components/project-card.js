class ProjectCard extends HTMLElement {
    connectedCallback() {
        ...
        this.shadowRoot.innerHTML = `
            ...
            <div class="project-card bg-white rounded-xl p-6 shadow-lg">
        ...
        // Add click event to navigate to editor
        this.shadowRoot.querySelector('.project-card').addEventListener('click', () => {

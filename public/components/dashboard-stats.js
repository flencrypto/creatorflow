            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="stat-card rounded-xl p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <i data-feather="star" class="text-purple-400 w-5 h-5"></i>
                    </div>
                ...
                <div class="stat-card rounded-xl p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <i data-feather="activity" class="text-blue-400 w-5 h-5"></i>
                    </div>
                ...
                <div class="stat-card rounded-xl p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <i data-feather="layout" class="text-green-400 w-5 h-5"></i>
                    </div>
                ...
                <div class="stat-card rounded-xl p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <i data-feather="globe" class="text-orange-400 w-5 h-5"></i>
                    </div>
